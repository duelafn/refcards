% VERSION = 0.0000;# Created: 2009-10-29
% Release quality: Incomplete
...
\lr{setTimeout(\"<eval str>\", <milliseconds>);}{}
...
\lr{.sort(func cmp(a,b)\{\})}{return neg if a before b}
...
\lr{\opt{change}}{content of a field changes}
...
\lr{mouseover, mouseout}{same, but re-fire ``out''}
...
\lr{.innerHTML}{for container objects}
...
\lr*{.load(<url>,<data>,<complete>(<text>,<status>,<jqXHR>))}{Loads response into element}
\lr{\$.get(<url>,<data>,<sucess>(<data>,<status>,<jqXHR>),<type>)}{}
\lr{\$.post(<url>,<data>,<sucess>(<data>,<status>,<jqXHR>),<type>)}{}
\br

\lr{\$.getJSON(<url>,<data>,<sucess>(<data>,<status>,<jqXHR>))}{}
\lr{\$.getScript(<url_js>,<sucess>(<data>,<status>,<jqXHR>))}{}
\br
